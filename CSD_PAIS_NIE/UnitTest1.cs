...

{
    ...
    public class PAIS
    {
        ...
        public void A_LocalPO()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).SendKeys("tyhgfbfd");
            Task.Delay(2000).Wait();
            ...
            Task.Delay(2000).Wait();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_HSNLabel_0")).SendKeys("HSN-09");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_POQtyLabel_0")).SendKeys("35");
            Task.Delay(2000).Wait();
        ...
        public void C_PREntry()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtContactNo")).SendKeys("8787899889");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextCmt")).SendKeys("pooopopopop");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_Grid_ItemEntry_QtyReq_0")).SendKeys("15");
            Task.Delay(2000).Wait();
        ...
        public void D_POEntryFlow()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_HSNLabel_0")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_HSNLabel_0")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_HSNLabel_0")).SendKeys("HSN-11");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_UnitPriceText_0")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_UnitPriceText_0")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_GridViewPODetails_UnitPriceText_0")).SendKeys("20");
            Task.Delay(2000).Wait();
        ...
        public void E_GRNEntryFlow()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).SendKeys("08");
            Task.Delay(2000).Wait();
        ...
        public void H_POAmendment()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).SendKeys("oipoiiiyuy");
            Task.Delay(2000).Wait();
        ...
        public void L_POUpdate()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextComment")).SendKeys("zxcsdfdsf");
            Task.Delay(2000).Wait();
        ...
        public void M_ClonePR()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtRemarks")).SendKeys("rewrewrew");
            Task.Delay(2000).Wait();
        ...
        public void N_VendorEntry()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_PanNumTb")).SendKeys("ABCDE1009X");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("PANSearchTb")).SendKeys("ABCDE1009X");
            Task.Delay(2000).Wait();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_ButtonSearch")).Click();
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_contactNumTb")).SendKeys("87987786");
            Task.Delay(2000).Wait();
        ...
        public void O_PRImport()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtContactNo")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtContactNo")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtContactNo")).SendKeys("8978676456");
            Task.Delay(2000).Wait();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_DrpType")).Click();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextCmt")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextCmt")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextCmt")).SendKeys("tretwterwwe");
            Task.Delay(2000).Wait();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_add")).Click();
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_Grid_ItemEntry_QtyReq_0")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_Grid_ItemEntry_QtyReq_0")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_Grid_ItemEntry_QtyReq_0")).SendKeys("50");
            Task.Delay(2000).Wait();
        ...
        public void P_POImport()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextBox1")).SendKeys("TEST4");
            Task.Delay(2000).Wait();
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TextBoxCost1")).SendKeys("300");
            Task.Delay(2000).Wait();
        ...
        public void Q_ImportGRN()
        {
            ...
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_TxtInvNo")).SendKeys("09");
            Task.Delay(2000).Wait();
        ...
        public void R_UserManagment()
        {
            ...
            Task.Delay(2000).Wait();
            driver.SwitchTo().Window(driver.WindowHandles.Last());
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_popupPanelBaCode")).Click();
            Task.Delay(2000).Wait();
            driver.SwitchTo().Window(driver.WindowHandles.First());
            Task.Delay(2000).Wait();

            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_drpGrp")).Click();
            new SelectElement(driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_drpGrp"))).SelectByText("FOOD CONSUMABLES");
            Task.Delay(2000).Wait();

            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_drpUom")).Click();
            new SelectElement(driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_drpUom"))).SelectByText("CAN");
            Task.Delay(2000).Wait();

            var element0 = driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_ImageButton1"));
            var script0 = "arguments[0].scrollIntoView(true);";
            IJavaScriptExecutor js0 = (IJavaScriptExecutor)driver;
            js0.ExecuteScript(script0, element0);
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_ImageButton1")).Click();
            driver.SwitchTo().Window(driver.WindowHandles.Last());
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_panleHSN")).Click();
            Task.Delay(2000).Wait();
            driver.SwitchTo().Window(driver.WindowHandles.First());
            Task.Delay(2000).Wait();

            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_ddlTaxClassification")).Click();
            new SelectElement(driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_ddlTaxClassification"))).SelectByText("GST Item");
            Task.Delay(2000).Wait();

            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtTaxRate")).Click();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtTaxRate")).Clear();
            driver.FindElement(By.Id("ContentPlaceHolder1_ContentPlaceHolder3_txtTaxRate")).SendKeys("15");
            Task.Delay(2000).Wait();
